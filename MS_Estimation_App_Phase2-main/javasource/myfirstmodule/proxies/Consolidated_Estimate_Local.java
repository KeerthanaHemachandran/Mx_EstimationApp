...
public class Consolidated_Estimate_Local
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject consolidated_Estimate_LocalMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "MyFirstModule.Consolidated_Estimate_Local";
	...
	public enum MemberNames
	{
		...
		Consolidated_Estimate_Local_Template("MyFirstModule.Consolidated_Estimate_Local_Template");
	...
	public Consolidated_Estimate_Local(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, "MyFirstModule.Consolidated_Estimate_Local"));
	}

	protected Consolidated_Estimate_Local(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject consolidated_Estimate_LocalMendixObject)
	{
		if (consolidated_Estimate_LocalMendixObject == null)
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		if (!com.mendix.core.Core.isSubClassOf("MyFirstModule.Consolidated_Estimate_Local", consolidated_Estimate_LocalMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a MyFirstModule.Consolidated_Estimate_Local");

		this.consolidated_Estimate_LocalMendixObject = consolidated_Estimate_LocalMendixObject;
		this.context = context;
	}

	/**
	 * @deprecated Use 'Consolidated_Estimate_Local.load(IContext, IMendixIdentifier)' instead.
	 */
	@Deprecated
	public static myfirstmodule.proxies.Consolidated_Estimate_Local initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return myfirstmodule.proxies.Consolidated_Estimate_Local.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static myfirstmodule.proxies.Consolidated_Estimate_Local initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new myfirstmodule.proxies.Consolidated_Estimate_Local(context, mendixObject);
	}

	public static myfirstmodule.proxies.Consolidated_Estimate_Local load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return myfirstmodule.proxies.Consolidated_Estimate_Local.initialize(context, mendixObject);
	}

	public static java.util.List<myfirstmodule.proxies.Consolidated_Estimate_Local> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<myfirstmodule.proxies.Consolidated_Estimate_Local> result = new java.util.ArrayList<myfirstmodule.proxies.Consolidated_Estimate_Local>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//MyFirstModule.Consolidated_Estimate_Local" + xpathConstraint))
			result.add(myfirstmodule.proxies.Consolidated_Estimate_Local.initialize(context, obj));
		return result;
	}
	...
	/**
	 * @return value of Consolidated_Estimate_Local_Template
	 */
	public final myfirstmodule.proxies.Template getConsolidated_Estimate_Local_Template() throws com.mendix.core.CoreException
	{
		return getConsolidated_Estimate_Local_Template(getContext());
	}
	 ...
	 * @return value of Consolidated_Estimate_Local_Template
	 */
	public final myfirstmodule.proxies.Template getConsolidated_Estimate_Local_Template(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		myfirstmodule.proxies.Template result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Consolidated_Estimate_Local_Template.toString());
		if (identifier != null)
	...
	/**
	 * Set value of Consolidated_Estimate_Local_Template
	 * @param consolidated_estimate_local_template
	 */
	public final void setConsolidated_Estimate_Local_Template(myfirstmodule.proxies.Template consolidated_estimate_local_template)
	{
		setConsolidated_Estimate_Local_Template(getContext(), consolidated_estimate_local_template);
	}
	 ...
	 * @param consolidated_estimate_local_template
	 */
	public final void setConsolidated_Estimate_Local_Template(com.mendix.systemwideinterfaces.core.IContext context, myfirstmodule.proxies.Template consolidated_estimate_local_template)
	{
		if (consolidated_estimate_local_template == null)
			getMendixObject().setValue(context, MemberNames.Consolidated_Estimate_Local_Template.toString(), null);
		else
			getMendixObject().setValue(context, MemberNames.Consolidated_Estimate_Local_Template.toString(), consolidated_estimate_local_template.getMendixObject().getId());
	}
	...
	{
		return consolidated_Estimate_LocalMendixObject;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final myfirstmodule.proxies.Consolidated_Estimate_Local that = (myfirstmodule.proxies.Consolidated_Estimate_Local) obj;
	...
	{
		return "MyFirstModule.Consolidated_Estimate_Local";
	}
