...
public class Java_action_Estimation_Data extends CustomJavaAction<java.lang.Long>
{
	...
	public Java_action_Estimation_Data(IContext context, java.math.BigDecimal SumSeriveType, java.math.BigDecimal SumPolicy, java.math.BigDecimal SumPattern, java.math.BigDecimal SumTechStack, java.math.BigDecimal SumDevProcess, java.util.List<IMendixObject> AssumptionObj)
	{
		super(context);
...
//	                ResultDev += Sum.doubleValue() * assumptions.getPercentage().doubleValue();
	...
	{
		return "Java_action_Estimation_Data";
	}
