...
public class GenerateExcelDoc extends CustomJavaAction<IMendixObject>
{
	...
	public IMendixObject executeAction() throws Exception
	{
        ...
        {
        	case XLS:    
        		filename = this.TemplateObject.getName().replace(" ", "_") + ".xls";
        	case XLSX:
    		...
    		default:
    			...
    			filename = this.TemplateObject.getName().replace(" ", "_") + ".csv";
        		export = new ExportCSV(this.getContext(), this.TemplateObject, this.InputObject);
        		break;
        }
